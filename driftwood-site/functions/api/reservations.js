...
// GET  /api/reservations?date=YYYY-MM-DD   -> availability for that date
// POST /api/reservations                   -> create a booking
//
// Requires a KV namespace bound to this Pages project as "RESERVATIONS".
// Set that up in Cloudflare dashboard > your Pages project > Settings > Functions > KV namespace bindings.
...
const SLOT_MINUTES = 30;         // one bookable slot every 30 minutes
const TABLES_PER_SLOT = 4;       // how many tables/parties can book the same slot
const MAX_PARTY_SIZE = 6;        // largest party a table can seat
const LAST_BOOKING_BUFFER_MIN = 60; // stop taking bookings this many minutes before close
// -----------------------------------
